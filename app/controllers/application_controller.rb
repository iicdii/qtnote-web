class ApplicationController < ActionController::Base
  ...
  def calculate_achievement
    if user_signed_in?
      # 연속 QT일 계산
      @streak_days = current_user.streak_start && current_user.streak_end && current_user.streak_end > Time.zone.yesterday.beginning_of_day ? (current_user.streak_end.to_date - current_user.streak_start.to_date).to_i  : 0
